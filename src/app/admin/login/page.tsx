...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ erro?: string }> }) {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-navy px-4">
      <form id="admin-login-form" action={login} className="w-full max-w-sm rounded-3xl bg-white p-8 shadow-soft">
        ...
        <div className="mt-4">
          <MobileLoginButton
            ...
            className="h-12 w-full rounded-full bg-red font-semibold text-white transition hover:bg-red-bright"
          >
            Entrar
          </MobileLoginButton>
        </div>
